...
const credentials = [
  { icon: "GraduationCap", text: "Бакалавр юриспруденции — СГЮА, Институт прокуратуры" },
  { icon: "GraduationCap", text: "Магистр права (правовое сопровождение бизнеса) — КФУ, Юридический факультет" },
  { icon: "Award", text: "Член Адвокатской палаты Пензенской области" },
  { icon: "MapPin", text: "Работаю в г. Пенза, Пензенской области и на всей территории России" },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-navy-700 font-ibm text-base leading-relaxed mb-4">
              Нуреев Ринат Робертович — практикующий адвокат со стажем более 5 лет и более 30 успешно завершённых дел. Веду дела в судах общей юрисдикции и арбитражных судах.
            </p>
